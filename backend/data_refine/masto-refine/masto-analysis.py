# masto_analysis.py
# This script is used to refine the data in the raw datatable of ES, generate targeted data from all mastodon history data
import random
import logging
...
def main():
    ...
    logging.info(f"=== Election analysis ingest complete, total indexed: {total_indexed} ===")
